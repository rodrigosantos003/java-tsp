...
for /l %%i in (1,1,10) do (
    java SimulatedAnnealingTSP ex4.txt 8 3 100 0.1
    echo.
)
...
for /l %%i in (1,1,10) do (
    java SimulatedAnnealingTSP ex9.txt 8 3 1000 0.95
    echo.
)
...
for /l %%i in (1,1,10) do (
    java SimulatedAnnealingTSP sp11.txt 8 5 100 0.999
    echo.
)
...
for /l %%i in (1,1,10) do (
    java SimulatedAnnealingTSP burma14.txt 8 5 100 0.999
    echo.
)
...
for /l %%i in (1,1,10) do (
    java SimulatedAnnealingTSP ulysses22.txt 8 10 100 0.99999
    echo.
)
